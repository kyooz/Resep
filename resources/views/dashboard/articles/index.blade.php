      ...
      <table class="table table-striped table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $article->title }}</td>
                <td>
                    <a href="/dashboard/articles/{{ $article->slug }}" class="badge bg-info"><i class="fas fa-eye"></i></a>
                    <a href="/dashboard/articles/{{ $article->slug }}/edit" class="badge bg-warning"><i class="fas fa-edit"></i></span></a>
