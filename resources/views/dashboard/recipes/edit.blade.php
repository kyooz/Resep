...
@section('container')
<div class="col-lg-8">
    <form method="post" action="/dashboard/recipes/{{ $recipe->slug }}" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            @if ($recipe->image)
                <img src="{{ asset('storage/' . $recipe->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
            @else
        ...
        <div class=" mb-3">
            ...
            @enderror
            <input id="body" type="hidden" name="body" value="{{ old('body', $recipe->body) }}">
